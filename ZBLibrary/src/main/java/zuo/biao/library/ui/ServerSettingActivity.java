...
//		switch (v.getId()) {
//			case R.uid.getCurrentServerAddress:
//				finish();
//				break;
//			case R.uid.tvServerSettingForward:
...
//				break;
//
//			case R.uid.tvServerSettingNormalSet:
//				saveAndExit(false);
//				break;
//			case R.uid.tvServerSettingTestSet:
//				saveAndExit(true);
//				break;
//
//			case R.uid.tvServerSettingNormalOpen:
//				toActivity(WebViewActivity.createIntent(context, "正式服务器", StringUtil.getNoBlankString(etServerSettingNormal)));
//				break;
//			case R.uid.tvServerSettingTestOpen:
...
//		}
//	}
	//Library内switch方法中case R.uid.idx会报错
	@Override
	public void onClick(View v) {
